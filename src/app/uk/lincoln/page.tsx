                    ...
                    <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                        ...
                        <ul className="text-green-800 space-y-2">
                          <li>• Practice facilities with cathedral city views and countryside settings</li>
                          <li>• Professional coaching in historic Lincolnshire surroundings</li>
                          <li>• Spacious ranges taking advantage of rural location</li>
                          <li>• Ranges reflecting aviation heritage and English countryside charm</li>
                          <li>• Competitive pricing for premium countryside facilities</li>
                          <li>• Year-round practice opportunities in scenic settings</li>
                        </ul>
                      </div>
                    </div>
                  </div>
