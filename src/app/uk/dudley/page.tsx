                    ...
                    <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                        ...
                        <ul className="text-green-800 space-y-2">
                          <li>• TopTracer and Power Tee technology available</li>
                          <li>• Undercover and fully carpeted practice areas</li>
                          <li>• Floodlit facilities for evening practice</li>
                          <li>• Professional coaching and academy programs</li>
                          <li>• Competitive pricing for premium technology</li>
                          <li>• All-weather practice capabilities</li>
                        </ul>
                      </div>
                    </div>
                  </div>
