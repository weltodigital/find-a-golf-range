...
export default function ChesterPage() {
  ...
  useEffect(() => {
    const loadChesterRanges = async () => {
      try {

        // Chester city center coordinates
        const CHESTER_CENTER = { lat: 53.1906, lng: -2.8919 }
        ...
        // Fetch ranges from Supabase for Chester specifically
        ...
        if (error) {
          console.error('Error loading Chester ranges:', error)
          setLoading(false)
          return
        }
        ...
        console.error('Unexpected error loading Chester ranges:', err)
      } finally {
        setLoading(false)
      }
    }
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-400">/</li>
                <li className="text-gray-700">Chester</li>
              </ol>
            </nav>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Golf Driving Ranges in Chester
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
                Chester and Cheshire's premier golf driving ranges. Find the perfect practice facility in this historic Roman city.
              </p>
            </div>
          </div>
        </section>
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  We don't have any driving ranges listed for Chester yet.
                </p>
              ...
              <>
                ...
                {/* Map Section */}
                <div className="mb-12">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Driving Range Locations in Chester</h2>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mt-12 space-y-8">
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm border">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Golf Driving Ranges in Chester</h2>

                <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                  <p>
                    Chester and Cheshire offer excellent golf practice opportunities in one of England's most historic cities. The area's golf ranges combine quality facilities with the charm of Roman heritage and easy access from across the North West. With {ranges.length} driving ranges now available in our directory, this area provides excellent golf facilities for players of all levels.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Why Chester for Golf Practice?</h3>

                  <p>
                    Chester's location and facilities provide ideal opportunities for golf practice. The area's accessibility and quality ranges make it perfect for golfers looking to improve their game in professional surroundings.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Cheshire Golf Scene</h3>

                  <p>
                    Cheshire offers diverse settings for golf practice, from modern facilities to traditional golf clubs. Chester's golf ranges cater to players of all skill levels, offering everything from covered bays to extensive outdoor ranges.
                  </p>

                  {ranges.length > 0 && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                      <h4 className="font-bold text-green-900 mb-3">Featured Ranges in Chester</h4>
              ...
              <div className="bg-gray-50 rounded-lg p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">About Golf in Chester</h2>

                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Are there driving ranges in Chester?</h3>
                    <p className="text-gray-600">
                      Yes! Chester has {ranges.length} driving ranges and golf practice facilities. Our directory includes established venues like {ranges.length > 0 ? ranges[0]?.name : 'various local facilities'} and other popular practice locations throughout the area.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">What makes Chester good for golf?</h3>
                    <p className="text-gray-600">
                      Chester offers excellent golf facilities with quality ranges and good accessibility. The area's golf community and facilities make it an attractive destination for golf practice and improvement.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">How do I get to golf ranges in Chester?</h3>
                    <p className="text-gray-600">
                      Chester is well-connected with good transport links and road access. Most driving ranges offer parking facilities, and the area's accessibility makes it easy to reach golf facilities from surrounding areas.
                    </p>
                  </div>
                </div>
              </div>
