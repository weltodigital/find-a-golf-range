...
export default function NewburyPage() {
  ...
  useEffect(() => {
    const loadNewburyRanges = async () => {
      try {
        // Newbury city center coordinates
        const NEWBURY_CENTER = { lat: 51.4014, lng: -1.3234 }
        ...
        // Fetch ranges from Supabase where city is Newbury
        ...
        if (error) {
          console.error('Error loading Newbury ranges:', error)
          setLoading(false)
          return
        }
        ...
        const transformedRanges: GolfRange[] = rangeData.map((range: any) => {
          ...
          return {
            ...
            latitude: range.latitude || NEWBURY_CENTER.lat,
            longitude: range.longitude || NEWBURY_CENTER.lng,
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">Loading Newbury ranges...</p>
          </div>
        </main>
        <Footer />
      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-400">/</li>
                <li className="text-gray-700">Newbury</li>
              </ol>
            </nav>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Best Golf Driving Ranges in Newbury
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
                Find the perfect driving range in Newbury for your golf practice. Compare prices, facilities, and distances from city center across {ranges.length} premium golf driving ranges in Newbury.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            {hasRanges ? (
              <>
                ...
                {/* Map Section */}
                <div className="mb-12">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Driving Range Locations in Newbury</h2>
                ...
                <div className="mt-12 space-y-8">
                  ...
                  <div className="bg-white rounded-lg p-8 shadow-sm border">
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Golf Driving Ranges in Newbury</h2>

                    <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                      <p>
                        Whether you're a beginner looking to improve your swing or a seasoned golfer maintaining your skills, Newbury offers some of the finest golf driving ranges in the UK. Our comprehensive directory features {ranges.length} carefully selected driving ranges across Newbury, each offering unique facilities and pricing to suit every golfer's needs.
                      </p>

                      <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">What Makes Newbury's Driving Ranges Special?</h3>

                      <p>
                        Newbury's driving ranges combine traditional golf practice with cutting-edge technology. From TrackMan Range systems that provide real-time shot data to Toptracer technology offering interactive gaming experiences, these facilities cater to golfers of all skill levels. Many ranges in Newbury also feature climate-controlled bays, making year-round practice comfortable regardless of weather conditions.
                      </p>

                      <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Popular Driving Ranges in Newbury</h3>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
                        <div className="bg-gray-50 p-6 rounded-lg">
                          <h4 className="font-bold text-gray-900 mb-3">Technology-Enhanced Ranges</h4>
                          <p className="text-gray-600">
                            Modern driving ranges in Newbury feature state-of-the-art ball tracking technology, providing instant feedback on distance, accuracy, and shot trajectory to help improve your game.
                          </p>
                        </div>
                        <div className="bg-gray-50 p-6 rounded-lg">
                          <h4 className="font-bold text-gray-900 mb-3">Scenic Practice Facilities</h4>
                          <p className="text-gray-600">
                            Many Newbury ranges take advantage of the area's beautiful countryside setting, offering picturesque practice environments in peaceful rural locations.
                          </p>
                        </div>
                      </div>

                      <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Driving Range Prices in Newbury</h3>

                      <p>
                        Newbury driving ranges offer competitive pricing with options to suit every budget. Prices typically range from budget-friendly options for casual practice to premium experiences with advanced technology. Many ranges also offer time-based pricing and membership packages for regular players.
                      </p>

                      <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Facilities and Amenities</h3>

                      <p>
                        Most driving ranges in Newbury offer more than just practice bays. Common amenities include on-site pro shops, food and beverage facilities, golf lessons with PGA professionals, and equipment rental. Many ranges are also part of larger golf complexes, offering access to full 18-hole courses, putting greens, and chipping areas.
                      </p>

                      <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Location and Accessibility</h3>

                      <p>
                        Newbury's driving ranges are conveniently located throughout the town and surrounding countryside. Whether you're in the town center or exploring the beautiful Berkshire countryside, you'll find a quality driving range within easy reach. Most facilities offer ample parking and good road access, making them convenient for regular practice sessions.
                      </p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-8">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">Frequently Asked Questions About Newbury Driving Ranges</h2>

                    <div className="space-y-6">
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">What is the best driving range in Newbury?</h3>
                        <p className="text-gray-600">
                          The best driving range depends on your needs. For technology enthusiasts, look for ranges with TrackMan or ball-tracking systems. For scenic practice, choose ranges with countryside views. For value, consider ranges with competitive pricing and good facilities.
                        </p>
                      </div>

                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">How much does it cost to use a driving range in Newbury?</h3>
                        <p className="text-gray-600">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Do Newbury driving ranges offer golf lessons?</h3>
                        <p className="text-gray-600">
                          Yes, most driving ranges in Newbury offer professional golf instruction. Many employ PGA qualified instructors and offer group lessons, individual coaching, and beginner programs.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Absolutely! Newbury's driving ranges welcome golfers of all skill levels. Many offer beginner-friendly features like shorter tee areas, equipment rental, and introductory lessons to help new golfers get started.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  We don't have any driving ranges listed for Newbury yet.
                </p>
