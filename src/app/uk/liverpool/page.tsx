                    ...
                    <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                        ...
                        <ul className="text-green-800 space-y-2">
                          ...
                          <li>• Floodlit ranges perfect for after-work practice</li>
                          <li>• Competitive pricing with excellent value packages</li>
                          <li>• Professional coaching and beginner-friendly facilities</li>
                          <li>• Convenient city and countryside locations</li>
                          <li>• Friendly Merseyside hospitality and welcoming atmosphere</li>
                        </ul>
                      </div>
                    </div>
                  </div>
