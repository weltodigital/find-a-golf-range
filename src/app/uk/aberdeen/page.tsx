...
export default function AberdeenPage() {
  ...
  useEffect(() => {
    const loadAberdeenRanges = async () => {
      try {
        ...
        // Fetch ranges from Supabase where city contains 'aberdeen'
        ...
        if (error) {
          console.error('Error loading Aberdeen ranges:', error)
          setLoading(false)
          return
        }
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">Loading Aberdeen ranges...</p>
          </div>
        </main>
        <Footer />
      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-400">/</li>
                <li className="text-gray-700">Aberdeen</li>
              </ol>
            </nav>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Best Golf Driving Ranges in Aberdeen
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
                Discover Scotland's granite city's finest driving ranges for your golf practice. Compare prices, facilities, and distances from Aberdeen city center across {ranges.length} premium golf driving ranges throughout Aberdeen and Aberdeenshire.
              </p>
              <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-700">
                <span className="bg-white px-3 py-1 rounded-full shadow-sm">⛰️ Scenic Highland Views</span>
                <span className="bg-white px-3 py-1 rounded-full shadow-sm">🏌️ Links-Style Practice</span>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  We don't have any driving ranges listed for Aberdeen yet.
                </p>
            ...
            <div className="mt-12 space-y-8">
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm border">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Golf Driving Ranges in Aberdeen</h2>

                <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                  <p>
                    Aberdeen and Aberdeenshire offer excellent golf practice opportunities in this granite city. The area's golf facilities and Scottish heritage make it ideal for players from across the region. With {ranges.length} driving ranges now available in our directory, this area provides excellent golf facilities for players of all levels.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Why Aberdeen for Golf Practice?</h3>

                  <p>
                    Aberdeen's location in Aberdeenshire and Scottish golf tradition provide ideal opportunities for golf practice. The area's accessibility and quality ranges make it perfect for golfers looking to improve their game in professional surroundings.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Aberdeenshire Golf Scene</h3>

                  <p>
                    Aberdeenshire offers diverse settings for golf practice, from modern facilities to traditional Scottish golf clubs. Aberdeen's golf ranges cater to players of all skill levels, offering everything from covered bays to extensive outdoor ranges with stunning Scottish views.
                  </p>

                  {ranges.length > 0 && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                      <h4 className="font-bold text-green-900 mb-3">Featured Ranges in Aberdeen</h4>
              ...
              <div className="bg-gray-50 rounded-lg p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">About Golf in Aberdeen</h2>

                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Are there driving ranges in Aberdeen?</h3>
                    <p className="text-gray-600">
                      Yes! Aberdeen has {ranges.length} driving ranges and golf practice facilities. Our directory includes established venues like {ranges.length > 0 ? ranges[0]?.name : 'various local facilities'} and other popular practice locations throughout the Aberdeenshire area.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">What makes Aberdeen good for golf?</h3>
                    <p className="text-gray-600">
                      Aberdeen offers excellent golf facilities with quality ranges and Scotland's rich golf heritage. The area's golf community and facilities make it an attractive destination for golf practice and improvement.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">How do I get to golf ranges in Aberdeen?</h3>
                    <p className="text-gray-600">
                      Aberdeen is well-connected with good transport links throughout Aberdeenshire. Most driving ranges offer parking facilities, and the area's accessibility makes it easy to reach golf facilities from surrounding areas.
                    </p>
                  </div>
                </div>
              </div>
