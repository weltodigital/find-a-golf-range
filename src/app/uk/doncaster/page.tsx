...
export default function DoncasterPage() {
  ...
  useEffect(() => {
    const loadDoncasterRanges = async () => {
      try {

        // Doncaster city center coordinates
        const DONCASTER_CENTER = { lat: 53.5228, lng: -1.1285 }
        ...
        // Fetch ranges from Supabase where city contains 'doncaster'
        ...
        if (error) {
          console.error('Error loading Doncaster ranges:', error)
          setLoading(false)
          return
        }
        ...
        const transformedRanges: GolfRange[] = filteredRangeData.map((range: any) => {
          ...
          if (range.latitude && range.longitude) {
            distance = Math.round(calculateDistance(
              DONCASTER_CENTER.lat,
              DONCASTER_CENTER.lng,
              range.latitude,
              range.longitude
            ) * 10) / 10
          }
        ...
        console.error('Unexpected error loading Doncaster ranges:', err)
      } finally {
        setLoading(false)
      }
    }
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-400">/</li>
                <li className="text-gray-700">Doncaster</li>
              </ol>
            </nav>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Golf Driving Ranges in Doncaster
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
                Doncaster and South Yorkshire's premier golf driving ranges. Find the perfect practice facility in this metropolitan borough.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-50 rounded-lg p-4">
                    <label className="text-sm font-medium text-gray-700">
                      Distance from Doncaster center:
                    </label>
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  We don't have any driving ranges listed for Doncaster yet.
                </p>
            ...
            <div className="mt-12 space-y-8">
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm border">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Golf Driving Ranges in Doncaster</h2>
                ...
                <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                  ...
                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Why Doncaster for Golf Practice?</h3>

                  <p>
                    Doncaster's location and facilities provide ideal opportunities for golf practice. The area's accessibility and quality ranges make it perfect for golfers looking to improve their game in professional surroundings.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">South Yorkshire Golf Scene</h3>

                  <p>
                    South Yorkshire offers diverse settings for golf practice, from modern facilities to traditional golf clubs. Doncaster's golf ranges cater to players of all skill levels, offering everything from covered bays to extensive outdoor ranges.
                  </p>

                  {ranges.length > 0 && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                      <h4 className="font-bold text-green-900 mb-3">Featured Ranges in Doncaster</h4>
              ...
              <div className="bg-gray-50 rounded-lg p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">About Golf in Doncaster</h2>

                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Are there driving ranges in Doncaster?</h3>
                    <p className="text-gray-600">
                      Yes! Doncaster has {ranges.length} driving ranges and golf practice facilities. Our directory includes established venues like {ranges.length > 0 ? ranges[0]?.name : 'various local facilities'} and other popular practice locations throughout the area.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">What makes Doncaster good for golf?</h3>
                    <p className="text-gray-600">
                      Doncaster offers excellent golf facilities with quality ranges and good accessibility. The area's golf community and facilities make it an attractive destination for golf practice and improvement.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">How do I get to golf ranges in Doncaster?</h3>
                    <p className="text-gray-600">
                      Doncaster is well-connected with good transport links and road access. Most driving ranges offer parking facilities, and the area's accessibility makes it easy to reach golf facilities from surrounding areas.
                    </p>
                  </div>
                </div>
              </div>
