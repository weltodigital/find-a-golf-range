...
export default function CambridgePage() {
  ...
  useEffect(() => {
    const loadCambridgeRanges = async () => {
      try {
        // Cambridge city center coordinates
        const CAMBRIDGE_CENTER = { lat: 52.2053, lng: 0.1218 }
        ...
        if (error) {
          console.error('Error loading Cambridge ranges:', error)
          setLoading(false)
          return
        }

        // Filter for ranges in Cambridge and transform
        const transformedRanges: GolfRange[] = rangeData
          ...
          .filter(range =>
            range.city?.toLowerCase() === 'cambridge'
          )
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">Loading Cambridge ranges...</p>
          </div>
        </main>
        <Footer />
      </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-400">/</li>
                <li className="text-gray-700">Cambridge</li>
              </ol>
            </nav>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Best Golf Driving Ranges in Cambridge
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
                Discover exceptional driving ranges in Cambridge, Cambridgeshire. Perfect practice facilities in the historic university city and surrounding countryside.
              </p>
              <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-700">
                <span className="bg-white px-3 py-1 rounded-full shadow-sm">🎓 University City</span>
                <span className="bg-white px-3 py-1 rounded-full shadow-sm">🏌️ Quality Facilities</span>
                <span className="bg-white px-3 py-1 rounded-full shadow-sm">🎯 Professional Coaching</span>
                <span className="bg-white px-3 py-1 rounded-full shadow-sm">🚗 A14 Access</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 bg-white border-b">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-primary">£{ranges.length > 0 ? '5-12' : '0'}</div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            {ranges.length > 0 ? (
              <>
                ...
                <div className="mb-8 space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-50 rounded-lg p-4">
                    <label className="text-sm font-medium text-gray-700">
                      Distance from Cambridge center:
                    </label>
                ...
                {/* Map Section */}
                <div className="mb-12">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Driving Range Locations in Cambridge</h2>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  We don't have any driving ranges listed for Cambridge yet.
                </p>
