...
export default function WrexhamPage() {
  ...
  useEffect(() => {
    const loadWrexhamRanges = async () => {
      try {

        // Wrexham city center coordinates
        const WREXHAM_CENTER = { lat: 53.0462, lng: -2.9931 }
        ...
        // Fetch ranges from Supabase where city is Wrexham
        console.log('🔍 Fetching Wrexham ranges...')
        ...
        if (error) {
          console.error('❌ Error loading Wrexham ranges:', error)
          setLoading(false)
          return
        }

        console.log('✅ Fetched', rangeData?.length || 0, 'Wrexham ranges')
        ...
        console.error('Unexpected error loading Wrexham ranges:', err)
      } finally {
        setLoading(false)
      }
    }
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-400">/</li>
                <li className="text-gray-700">Wrexham</li>
              </ol>
            </nav>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Golf Driving Ranges in Wrexham
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
                Wrexham and Wrexham's premier golf driving ranges. Find the perfect practice facility in this market town.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 bg-white border-b">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-primary">Wrexham</div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            {ranges.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  We don't have any driving ranges listed for Wrexham yet.
                </p>
            ...
            <div className="mt-12 space-y-8">
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm border">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Golf Driving Ranges in Wrexham</h2>

                <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                  <p>
                    Wrexham and Wrexham offer excellent golf practice opportunities in this market town. The area's golf facilities and Welsh heritage make it ideal for players from across the region. With {ranges.length} driving ranges now available in our directory, this area provides excellent golf facilities for players of all levels.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Why Wrexham for Golf Practice?</h3>

                  <p>
                    Wrexham's location in Wrexham and Welsh golf tradition provide ideal opportunities for golf practice. The area's accessibility and quality ranges make it perfect for golfers looking to improve their game in professional surroundings.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Wrexham Golf Scene</h3>

                  <p>
                    Wrexham offers diverse settings for golf practice, from modern facilities to traditional Welsh golf clubs. Wrexham's golf ranges cater to players of all skill levels, offering everything from covered bays to extensive outdoor ranges with stunning Welsh countryside views.
                  </p>

                  {ranges.length > 0 && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                      <h4 className="font-bold text-green-900 mb-3">Featured Ranges in Wrexham</h4>
              ...
              <div className="bg-gray-50 rounded-lg p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">About Golf in Wrexham</h2>

                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Are there driving ranges in Wrexham?</h3>
                    <p className="text-gray-600">
                      Yes! Wrexham has {ranges.length} driving ranges and golf practice facilities. Our directory includes established venues like {ranges.length > 0 ? ranges[0]?.name : 'various local facilities'} and other popular practice locations throughout the Wrexham area.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">What makes Wrexham good for golf?</h3>
                    <p className="text-gray-600">
                      Wrexham offers excellent golf facilities with quality ranges and Wales' rich golf heritage. The area's golf community and facilities make it an attractive destination for golf practice and improvement.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">How do I get to golf ranges in Wrexham?</h3>
                    <p className="text-gray-600">
                      Wrexham is well-connected with good transport links throughout Wrexham. Most driving ranges offer parking facilities, and the area's accessibility makes it easy to reach golf facilities from surrounding areas.
                    </p>
                  </div>
                </div>
              </div>
