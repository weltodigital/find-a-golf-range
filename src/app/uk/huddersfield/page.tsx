...
export default function HuddersfieldPage() {
  ...
  useEffect(() => {
    const loadHuddersfieldRanges = async () => {
      try {

        // Huddersfield city center coordinates
        const HUDDERSFIELD_CENTER = { lat: 53.6458, lng: -1.785 }
        ...
        // Fetch ranges from Supabase where city contains 'huddersfield'
        const { data: rangeData, error } = await supabase
          .from('golf_ranges')
          .select('*')
          .gt('latitude', 0)
          .eq('city', 'Huddersfield')
          .order('name')

        if (error) {
          console.error('Error loading Huddersfield ranges:', error)
          setLoading(false)
          return
        }
        ...
        const transformedRanges: GolfRange[] = rangeData.map((range: any) => {
          ...
          if (range.latitude && range.longitude) {
            distance = Math.round(calculateDistance(
              HUDDERSFIELD_CENTER.lat,
              HUDDERSFIELD_CENTER.lng,
              range.latitude,
              range.longitude
            ) * 10) / 10
          }
        ...
        console.error('Unexpected error loading Huddersfield ranges:', err)
      } finally {
        setLoading(false)
      }
    }

    loadHuddersfieldRanges()
  }, [])
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-400">/</li>
                <li className="text-gray-700">Huddersfield</li>
              </ol>
            </nav>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Golf Driving Ranges in Huddersfield
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
                Huddersfield and West Yorkshire's premier golf driving ranges. Find the perfect practice facility in this large town.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 bg-white border-b">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-primary">Large Town</div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 space-y-4">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <h2 className="text-3xl font-bold text-gray-900">
                      All Huddersfield Driving Ranges
                    </h2>
                    <select
                      value={sortBy}
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-50 rounded-lg p-4">
                    <label className="text-sm font-medium text-gray-700">
                      Distance from Huddersfield center:
                    </label>
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  We don't have any driving ranges listed for Huddersfield yet.
                </p>
            ...
            <div className="mt-12 space-y-8">
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm border">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Golf Driving Ranges in Huddersfield</h2>

                <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                  <p>
                    Huddersfield and West Yorkshire offer excellent golf practice opportunities in this vibrant large town. The area's golf facilities and accessibility make it ideal for players from across the region. With {ranges.length} driving ranges now available in our directory, this area provides excellent golf facilities for players of all levels.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Why Huddersfield for Golf Practice?</h3>

                  <p>
                    Huddersfield's location and facilities provide ideal opportunities for golf practice. The area's accessibility and quality ranges make it perfect for golfers looking to improve their game in professional surroundings.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">West Yorkshire Golf Scene</h3>

                  <p>
                    West Yorkshire offers diverse settings for golf practice, from modern facilities to traditional golf clubs. Huddersfield's golf ranges cater to players of all skill levels, offering everything from covered bays to extensive outdoor ranges.
                  </p>

                  {ranges.length > 0 && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                      <h4 className="font-bold text-green-900 mb-3">Featured Ranges in Huddersfield</h4>
              ...
              <div className="bg-gray-50 rounded-lg p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">About Golf in Huddersfield</h2>

                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Are there driving ranges in Huddersfield?</h3>
                    <p className="text-gray-600">
                      Yes! Huddersfield has {ranges.length} driving ranges and golf practice facilities. Our directory includes established venues like {ranges.length > 0 ? ranges[0]?.name : 'various local facilities'} and other popular practice locations throughout the area.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">What makes Huddersfield good for golf?</h3>
                    <p className="text-gray-600">
                      Huddersfield offers excellent golf facilities with quality ranges and good accessibility. The area's golf community and facilities make it an attractive destination for golf practice and improvement.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">How do I get to golf ranges in Huddersfield?</h3>
                    <p className="text-gray-600">
                      Huddersfield is well-connected with good transport links and road access. Most driving ranges offer parking facilities, and the area's accessibility makes it easy to reach golf facilities from surrounding areas.
                    </p>
                  </div>
                </div>
              </div>
