...
export default function DunfermlinePage() {
  ...
  useEffect(() => {
    const loadDunfermlineRanges = async () => {
      try {

        // Dunfermline city center coordinates
        const DUNFERMLINE_CENTER = { lat: 56.072, lng: -3.4581 }
        ...
        // Fetch ranges from Supabase where city contains 'dunfermline'
        ...
        if (error) {
          console.error('Error loading Dunfermline ranges:', error)
          setLoading(false)
          return
        }
        ...
        const transformedRanges: GolfRange[] = filteredRangeData.map((range: any) => {
          ...
          if (range.latitude && range.longitude) {
            distance = Math.round(calculateDistance(
              DUNFERMLINE_CENTER.lat,
              DUNFERMLINE_CENTER.lng,
              range.latitude,
              range.longitude
            ) * 10) / 10
          }
        ...
        console.error('Unexpected error loading Dunfermline ranges:', err)
      } finally {
        setLoading(false)
      }
    }

    loadDunfermlineRanges()
  }, [])
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-400">/</li>
                <li className="text-gray-700">Dunfermline</li>
              </ol>
            </nav>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Golf Driving Ranges in Dunfermline
              </h1>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
                Dunfermline and Fife's premier golf driving ranges. Find the perfect practice facility in this ancient capital.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-8 bg-white border-b">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-primary">Fife</div>
                <div className="text-sm text-gray-600">Region</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-primary">Ancient Capital</div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 space-y-4">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <h2 className="text-3xl font-bold text-gray-900">
                      All Dunfermline Driving Ranges
                    </h2>
                    <select
                      value={sortBy}
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-50 rounded-lg p-4">
                    <label className="text-sm font-medium text-gray-700">
                      Distance from Dunfermline center:
                    </label>
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  We don't have any driving ranges listed for Dunfermline yet.
                </p>
            ...
            <div className="mt-12 space-y-8">
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm border">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Golf Driving Ranges in Dunfermline</h2>

                <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                  <p>
                    Dunfermline and Fife offer excellent golf practice opportunities in this ancient capital. The area's golf facilities and Scottish heritage make it ideal for players from across the region. With {ranges.length} driving ranges now available in our directory, this area provides excellent golf facilities for players of all levels.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Why Dunfermline for Golf Practice?</h3>

                  <p>
                    Dunfermline's location in Fife and Scottish golf tradition provide ideal opportunities for golf practice. The area's accessibility and quality ranges make it perfect for golfers looking to improve their game in professional surroundings.
                  </p>

                  <h3 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Fife Golf Scene</h3>

                  <p>
                    Fife offers diverse settings for golf practice, from modern facilities to traditional Scottish golf clubs. Dunfermline's golf ranges cater to players of all skill levels, offering everything from covered bays to extensive outdoor ranges with stunning Scottish views.
                  </p>

                  {ranges.length > 0 && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-6 mt-8">
                      <h4 className="font-bold text-green-900 mb-3">Featured Ranges in Dunfermline</h4>
              ...
              <div className="bg-gray-50 rounded-lg p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">About Golf in Dunfermline</h2>

                <div className="space-y-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Are there driving ranges in Dunfermline?</h3>
                    <p className="text-gray-600">
                      Yes! Dunfermline has {ranges.length} driving ranges and golf practice facilities. Our directory includes established venues like {ranges.length > 0 ? ranges[0]?.name : 'various local facilities'} and other popular practice locations throughout the Fife area.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">What makes Dunfermline good for golf?</h3>
                    <p className="text-gray-600">
                      Dunfermline offers excellent golf facilities with quality ranges and Scotland's rich golf heritage. The area's golf community and facilities make it an attractive destination for golf practice and improvement.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">How do I get to golf ranges in Dunfermline?</h3>
                    <p className="text-gray-600">
                      Dunfermline is well-connected with good transport links throughout Fife. Most driving ranges offer parking facilities, and the area's accessibility makes it easy to reach golf facilities from surrounding areas.
                    </p>
                  </div>
                </div>
              </div>
